...
public class Server {
    ...
    public static class SCP extends Thread {
        ...
        boolean Autor() throws IOException {
            ...
            System.out.println("Я получил от клиента #" + number + ": " + OUTPUT);

            while((mess = this.readerF.readLine())!= null) {
                if(mess.equals(OUTPUT)) {
                    INFO = OUTPUT.split(" ");
                    OUTPUT = Integer.toString(this.sock.getPort());
                    Users.add(Users.size(),INFO[0] + " " + OUTPUT);
                    this.NAME = INFO[0];
                    System.out.println("Я отправил клиенту #" + number + ": " + "0");
                    this.writer.write("1" + "\n");
                    this.writer.flush();
                    return true;
                }
        ...
        void CheckOnline() throws IOException {
            ...
            System.out.println("Я отправил клиенту #" + number + ": " + ONUSr);
        ...
        void Send() throws IOException {
            ...
            System.out.println("Я получил от клиента #" + number + ": " + "\nИмя пользователя:" + Dest + "\nСообщение:" + SendMsg);
            for (String user : Users) {
            ...
            this.writerFM.flush();
            System.out.println("Я отправил клиенту #" + number + ": " + "Сообщение отправлено!");
            this.writer.write("Сообшение отправленно!" + "\n");
            this.writer.flush();
        }
        ...
        void CheckBox() throws IOException {
            ...
            System.out.println("Я отправил клиенту #" + number + ": " + deliver);
            ...
            try {
                ...
                while(isOnline) {
                    ...
                    if(Enter) {
                        ...
                        switch (Massage) {
                            case "1": System.out.println("Клиент #" + this.number + " решил авторизоваться."); Enter = Autor();
                                if(Enter) {
                                    System.out.println("Клиент #" + this.number + " авторизоавлся. (LOGIN:" + this.NAME + ")");
                                }break;
